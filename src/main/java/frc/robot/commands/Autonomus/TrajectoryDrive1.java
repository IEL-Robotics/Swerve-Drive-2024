...
public class TrajectoryDrive1 extends SequentialCommandGroup {
  ...
  public TrajectoryDrive1(SwerveSubsystem swerveSubsystem, Vision vision, double[] endX, double[] endY, double endTheta,
    ...
    Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
        new Pose2d(positions[0] * 3.28084, positions[1] * 3.28084, Rotation2d.fromDegrees(positions[2])), // old -> new
                                                                                                          // Rotation2d(radians)
        wayPoints,
  ...
  public void setOdometryVision() {
    do {
      System.out.println("Still Searching AprilTag");
